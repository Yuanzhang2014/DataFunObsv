...
* `neuron_nonlinear_mc.m`: Monte Carlo evaluation of Koopman-based nonlinear observer performance by computing time-varying RMSE (Root Mean Square Error) across Nr experiments.
